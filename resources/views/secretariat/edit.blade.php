...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('secretariat.secretariat.update', $Archive->id) }}" id="edit_letter_form" name="edit_letter_form" accept-charset="UTF-8" class="form-horizontal row">
            {{ csrf_field() }}
