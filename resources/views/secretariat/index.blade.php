    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('secretariat.secretariat.create') }}" class="btn btn-success" title="{{ trans('letters.create') }}">
                    ...
                    @foreach($Archives as $archive)
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{!! route('secretariat.secretariat.destroy', $archive->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('secretariat.secretariat.show', $archive->id ) }}" class="btn btn-info" title="{{ trans('secretariat.show') }}">
                                            <span class="glyphicon glyphicon-open" aria-hidden="true"></span>
                                        </a>
                                        @if(auth()->user()->id == $archive->from || auth()->user()->hasRole('super admin'))
                                        <a href="{{ route('secretariat.secretariat.edit', $archive->id ) }}" class="btn btn-primary" title="{{ trans('letters.edit') }}">
