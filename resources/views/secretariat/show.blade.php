...
<br>
          <div class="row">
          <div class="col-md-3">
           @if($archive->Signature == '1')


<img src="{{ asset($users->Signature) }}" style="    max-width: 300px;" type="text" class="form-control uploaded-file-name" id="image" readonly>
           @endif
...
<img src="{{ asset($stamps->image) }}" style="    max-width: 300px;" type="text" class="form-control uploaded-file-name" id="image" readonly>
           @endif
